...
export default function Footer() {
    return (
        <div className="bg-brightblue text-white ">
            <div className="container">
                <div className="flex flex-col lg:items-center px-3 xs:px-5 lg:px-4 pt-16">
                    <div id='top-footer'>
                        <div className='flex flex-col lg:items-center mb-8 xs:mb-0'>
                            <h2 className="text-3xl sm:text-5xl font-bold mb-12">Try Whitepace today</h2>
                            <p>
                    ...
                    <div id='mid-footer'
                        className='grid lg:grid-cols-5 grid-cols-1 place-items-center xs:place-items-start mt-24 xs:mt-20'>
                        <div className='mb-10 lg:mb-0 lg:mr-0 xs:mr-48 lg:w-4/5'>
                            ...
                            <p className='text-center xs:text-start xs:px-0 px-8'>whitepace was created for the new ways we live and work. We make a better workspace around the world</p>
                        </div>
                        {
